...
def play_markup(videoid, user_id):
    buttons= [
            ...
            [
                InlineKeyboardButton(text=f"✨ ɢʀᴏᴜᴘ", url=f"https://t.me/{PREDATOR_BOT_SUPPORT}"),
                InlineKeyboardButton(text=f"📣 ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/{PREDATOR_BOTS}"),
            ],
            [      
...
def others_markup(videoid, user_id):
    buttons= [
            [
                InlineKeyboardButton(text="✨ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/{PREDATOR_BOTS}"),
